...
function createGUI() {
    ...
    advancedButtonsColorsCircle.push(new Button(rightSideBar + 0, height + 30, 200, "Red", function() { colors.circleRed = 150; colors.circleGreen = 0; colors.circleBlue = 0;}));
    ...
    advancedButtonsColorsCircle.push(new Button(rightSideBar + 0, height + 120, 200, "Green", function() { colors.circleRed = 0; colors.circleGreen = 150; colors.circleBlue = 0;}));
    ...
    advancedButtonsColorsCircle.push(new Button(rightSideBar + 0, height + 210, 200, "Blue", function() { colors.circleRed = 0; colors.circleGreen = 0; colors.circleBlue = 150;}));
    ...
    advancedButtonsColorsLine.push(new Button(rightSideBar + 0, height + 30, 200, "Red", function() { colors.lineRed = 150; colors.lineGreen = 0; colors.lineBlue = 0;}));
    ...
    advancedButtonsColorsLine.push(new Button(rightSideBar + 0, height + 120, 200, "Green", function() { colors.lineRed = 0; colors.lineGreen = 150; colors.lineBlue = 0;}));
    ...
    advancedButtonsColorsLine.push(new Button(rightSideBar + 50, height + 180, 50, "-1", function() { colors.lineGreen -= 1; if(colors.lineGreen < 0){colors.lineGreen = 0;} redraw();}));
    ...
    advancedButtonsColorsLine.push(new Button(rightSideBar + 0, height + 210, 200, "Blue", function() { colors.lineRed = 0; colors.lineGreen = 0; colors.lineBlue = 150;}));
    ...
    advancedButtonsColorsDot.push(new Button(rightSideBar + 0, height + 30, 200, "Red", function() { colors.dotRed = 150; colors.dotGreen = 0; colors.dotBlue = 0;}));
    ...
    advancedButtonsColorsDot.push(new Button(rightSideBar + 0, height + 120, 200, "Green", function() { colors.dotRed = 0; colors.dotGreen = 150; colors.dotBlue = 0;}));
    ...
    advancedButtonsColorsDot.push(new Button(rightSideBar + 0, height + 210, 200, "Blue", function() { colors.dotRed = 0; colors.dotGreen = 0; colors.dotBlue = 150;}));
    ...
    advancedButtonsColorsBackground.push(new Button(rightSideBar + 0, height + 30, 200, "Red", function() { colors.backgroundRed = 200; colors.backgroundGreen = 100; colors.backgroundBlue = 100;}));
    ...
    advancedButtonsColorsBackground.push(new Button(rightSideBar + 0, height + 120, 200, "Green", function() { colors.backgroundRed = 100; colors.backgroundGreen = 200; colors.backgroundBlue = 100;}));
    ...
    advancedButtonsColorsBackground.push(new Button(rightSideBar + 0, height + 210, 200, "Blue", function() { colors.backgroundRed = 100; colors.backgroundGreen = 100; colors.backgroundBlue = 200;}));
